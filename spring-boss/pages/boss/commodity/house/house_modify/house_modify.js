// pages/boss/commodity/house/house_modity/house_modity.js
const HOUSE_UPDATE_URL = 'http://localhost:9010/allcontent/update';
const HOUSE_DELETE_URL = 'http://localhost:9010/allcontent/delete';
const HOUSE_GET_URL = 'http://localhost:9010/allcontent/get';
var app = getApp();
console.log(app);
Page({
